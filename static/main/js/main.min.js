...
$.inArray(g.split(".").pop(),["jpg","jpeg","png","gif"])>-1&&(i=$('<div id="gallery-overlay"></div>'),a=$('<i id="gallery-overlay-close" class="material-icons">close</i>'),n=$('<i id="gallery-overlay-previous" class="material-icons">chevron_right</i>'),o=$('<i id="gallery-overlay-next" class="material-icons">chevron_left</i>'),s=$('<p id="gallery-overlay-title" class="hide"></p>'),d=$("<ul></ul>"),l=null,c=0,r=0,u=function(t){27===t.keyCode?a.click():37===t.keyCode?n.click():39===t.keyCode&&o.click()},h.each(function(e){var i,a,n,o=$(this).attr("href"),l=$(this).attr("title")
